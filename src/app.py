from h2o_wave import app  # type: ignore
from h2o_wave import Q  # type: ignore
from h2o_wave import ui  # type: ignore
...
async def serve(q: Q):
    ...
    if q.args.step1:
        wizard.items = [
            ...
            ui.textbox(name="name", label="My name is...", value="Gandalf"),
        ...
        wizard.items = [
            ...
            ui.text(f"Hi {q.args.name}! How do you feel right now?", name="text"),
        ...
        wizard.items = [
            ...
            ui.text(
                f"What a coincidence, {q.client.name}! I feel {q.args.feeling} too!",
                name="text",
            ),
